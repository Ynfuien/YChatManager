...
import pl.ynfuien.ychatmanager.config.updater.ConfigUpdater;
...
public class ConfigObject {
    ...
    private void logError(String message) {
        Logger.logWarning(String.format("[Config] [%s] %s", name.getFileName(), message));
    }
    private void logInfo(String message) {
        Logger.log(String.format("[Config] [%s] %s", name.getFileName(), message));
    }
